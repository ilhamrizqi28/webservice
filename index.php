    ...
    <body>
        <div class="container mt-4 ml-7 mr-7">
            ...
            <div class="row text-center">
              <div class="col-sm"><strong>Nama:</strong> Ilham Rizqi Furqon</div>
              <div class="col-sm"><strong>Nim:</strong> 17.01.53.0002</div>
            </div>
            ...
            <div class="notif text-center mt-4 mb-2"></div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="desc" aria-describedby="Diskripsi" name="asset">
        ...
        <script>
            function get_data(){
                $.ajax({
                    url: 'https://majumapan.000webhostapp.com/json/tmbahjson.php',
                    method: "POST",
                    data: {show: 2},
                    dataType: "JSON",
                ...
                $('.masukkan').click(function(){
                    ...
                    // if(asset && desc_){
                        $.ajax({
                            url: 'https://majumapan.000webhostapp.com/json/tmbahjson.php',
                            method: "POST",
                            data: {asset: asset, desc_:desc_, show:1},
                            dataType: "JSON",
                            success: function(data){
                                setTimeout(function(){
